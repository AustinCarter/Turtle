...
namespace Turtle{
		...
		: m_Path(path)
	{
		...
		{
			TURT_PROFILE_SCOPE("2D texture load - OpenGLTexture2D::OpenGLTexture2D(const std::string&)");
	...
	void OpenGLTexture2D::SetData(void* data, uint32_t size)
	{
		...
		TURT_CORE_ASSERT(size == m_Width * m_Height * bpp, "Data must be entire texture");
