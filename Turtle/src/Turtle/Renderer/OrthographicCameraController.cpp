...
void OrthographicCameraController::OnEvent(Event &e) {
  ...
  dispatcher.Dispatch<MouseScrolledEvent>(
      TURT_BIND_EVENT_FN(OrthographicCameraController::OnMouseScrolled));
  dispatcher.Dispatch<WindowResizeEvent>(
      TURT_BIND_EVENT_FN(OrthographicCameraController::OnWindowResized));
}
...
bool OrthographicCameraController::OnWindowResized(WindowResizeEvent &e) {
  ...
  m_ZoomLevel, -yScale * m_ZoomLevel, yScale * m_ZoomLevel); return false;*/
}
...
-m_ZoomLevel, m_ZoomLevel}; m_Camera.SetProjection(m_Bounds.Left,
m_Bounds.Right, m_Bounds.Bottom, m_Bounds.Top);
}*/
} // namespace Turtle
