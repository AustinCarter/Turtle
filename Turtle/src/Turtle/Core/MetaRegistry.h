...
static void InitMetaRegistry() {
  entt::meta<Entity>().type("Entity"_hs).prop("Name"_hs, "Entity");
  ...
  entt::meta<ParticleProps>()
      .type("ParticleProps"_hs)
      ...
      .data<&ParticleProps::VelocityVariation, entt::as_ref_t>(
          "VelocityVariation"_hs)
  ...
  entt::meta<Input>()
      .type("Input"_hs)
      .prop("Name"_hs, "Input")
      .func<&Input::IsKeyPressed>("IsKeyPressed"_hs)
      .prop("Name"_hs, "IsKeyPressed")
